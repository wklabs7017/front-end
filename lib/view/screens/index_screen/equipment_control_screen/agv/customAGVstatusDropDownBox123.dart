...
class CustomAGVStatusDropDownBox123 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomAGVStatusDropDownBox123State createState() =>
      _CustomAGVStatusDropDownBox123State();
}

var postController = Get.find<PostDeviceAgvStatusController>();
var getController = Get.find<GetDeviceAgvStatusController>();

class _CustomAGVStatusDropDownBox123State
    extends State<CustomAGVStatusDropDownBox123> {
