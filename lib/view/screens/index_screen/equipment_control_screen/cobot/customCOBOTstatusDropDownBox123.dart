...
class CustomCobotStatusDropDownBox123 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomCobotStatusDropDownBox123State createState() =>
      _CustomCobotStatusDropDownBox123State();
}

var postController = Get.find<PostDeviceCobotStatusController>();
var getController = Get.find<GetDeviceCobotStatusController>();

class _CustomCobotStatusDropDownBox123State
    extends State<CustomCobotStatusDropDownBox123> {
