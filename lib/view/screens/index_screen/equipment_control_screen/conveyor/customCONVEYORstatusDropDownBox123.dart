...
class CustomConveyorStatusDropDownBox123 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomConveyorStatusDropDownBox123State createState() =>
      _CustomConveyorStatusDropDownBox123State();
}

var postController = Get.find<PostDeviceConveyorStatusController>();
var getController = Get.find<GetDeviceConveyorStatusController>();

class _CustomConveyorStatusDropDownBox123State
    extends State<CustomConveyorStatusDropDownBox123> {
              ...
              child: _isEditing
                  ? DropdownButtonFormField<String>(
                      ...
                      value: dropdownOptions3
                              .contains(postController.statusController.text)
                          ? postController.statusController.text
                          : null,
                      ...
                      onChanged: (String? newValue) {
                        if (newValue != null) {
                          postController.statusController.text = newValue;
                        }
                      },
                    )
                  : Align(
