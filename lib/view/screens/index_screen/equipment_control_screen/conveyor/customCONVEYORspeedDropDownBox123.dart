...
class CustomCOnveyorSpeedDropDownBox123 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomConveyorSpeedDropDownBox123State createState() =>
      _CustomConveyorSpeedDropDownBox123State();
}
...
class _CustomConveyorSpeedDropDownBox123State
    extends State<CustomCOnveyorSpeedDropDownBox123> {
              ...
              child: _isEditing
                  ? DropdownButtonFormField<String>(
                      ...
                      value: dropdownOptions2
                              .contains(postController.speedController.text)
                          ? postController.speedController.text
                          : null,
                      ...
                      onChanged: (String? newValue) {
                        if (newValue != null) {
                          postController.speedController.text = newValue;
                        }
                      },
                    )
                  : Align(
