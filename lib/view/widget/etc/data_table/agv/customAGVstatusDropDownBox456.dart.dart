...
class CustomAGVStatusDropDownBox456 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomAGVStatusDropDownBox456State createState() =>
      _CustomAGVStatusDropDownBox456State();
}

var patchController = Get.find<PatchDeviceAgvStatusController>();
var getController = Get.find<GetDeviceAgvStatusController>();

class _CustomAGVStatusDropDownBox456State
    extends State<CustomAGVStatusDropDownBox456> {
