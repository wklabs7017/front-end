...
class CustomAGVModeDropDownBox456 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomAGVModeDropDownBox456State createState() =>
      _CustomAGVModeDropDownBox456State();
}

var patchController = Get.find<PatchDeviceAgvModeController>();
var getController = Get.find<GetDeviceAgvStatusController>();

class _CustomAGVModeDropDownBox456State
    extends State<CustomAGVModeDropDownBox456> {
