...
class CustomConveyorSpeedDropDownBox456 extends StatefulWidget {
  final String label;
  final String? text; // 이제 text는 초기 선택된 값으로 사용됩니다.

  CustomConveyorSpeedDropDownBox456({
    Key? key,
    required this.label,
    this.text,
  }) : super(key: key);
  ...
  @override
  _CustomConveyorSpeedDropDownBox456State createState() =>
      _CustomConveyorSpeedDropDownBox456State();
}

var patchController = Get.find<PatchDeviceConveyorSpeedController>();
var getController = Get.find<GetDeviceConveyorStatusController>();

class _CustomConveyorSpeedDropDownBox456State
    extends State<CustomConveyorSpeedDropDownBox456> {
  bool _isEditing = false;
  String? _selectedValue;

  final List<String> dropdownOptions2 = [
    '1',
    '2',
    '3',
    '4',
              ...
              child: _isEditing
                  ? DropdownButtonFormField<String>(
                      ...
                      value: dropdownOptions2
                              .contains(patchController.speedController.text)
                          ? patchController.speedController.text
                          : null,
                      ...
                      onChanged: (String? newValue) {
                        if (newValue != null) {
                          patchController.speedController.text = newValue;
                        }
                      },
                    )
                  : Align(
