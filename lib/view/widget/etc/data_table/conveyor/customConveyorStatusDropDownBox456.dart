...
class CustomConveyorStatusDropDownBox456 extends StatefulWidget {
  final String label;
  final String? text; // 이제 text는 초기 선택된 값으로 사용됩니다.

  CustomConveyorStatusDropDownBox456({
    Key? key,
    required this.label,
    this.text,
  }) : super(key: key);
  ...
  @override
  _CustomConveyorStatusDropDownBox456State createState() =>
      _CustomConveyorStatusDropDownBox456State();
}

var patchController = Get.find<PatchDeviceConveyorStatusController>();
var getController = Get.find<GetDeviceConveyorStatusController>();

class _CustomConveyorStatusDropDownBox456State
    extends State<CustomConveyorStatusDropDownBox456> {
  bool _isEditing = false;
  String? _selectedValue;

  final List<String> dropdownOptions3 = ['ERROR', 'IDLE', 'RUNNING'];
            ...
            child: Container(
              ...
              child: _isEditing
                  ? DropdownButtonFormField<String>(
                      ...
                      value: dropdownOptions3
                              .contains(patchController.statusController.text)
                          ? patchController.statusController.text
                          : null,
                      ...
                      onChanged: (String? newValue) {
                        if (newValue != null) {
                          patchController.statusController.text = newValue;
                        }
                      },
                    )
                  : Align(
