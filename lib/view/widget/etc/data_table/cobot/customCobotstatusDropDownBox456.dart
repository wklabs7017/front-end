...
class CustomCobotStatusDropDownBox456 extends StatefulWidget {
  final String label;
  ...
  @override
  _CustomCobotStatusDropDownBox456State createState() =>
      _CustomCobotStatusDropDownBox456State();
}

var patchController = Get.find<PatchDeviceCobotStatusController>();
var getController = Get.find<GetDeviceCobotStatusController>();

class _CustomCobotStatusDropDownBox456State
    extends State<CustomCobotStatusDropDownBox456> {
