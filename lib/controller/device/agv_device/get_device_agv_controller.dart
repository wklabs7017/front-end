...
class GetDeviceAGVController extends GetxController {
  int? id;
  String? accessToken;
  final Dio dio = Dio();
  ...
  Future<void> fetchDevicesInRange(
    ...
    List<Device> agvDevices =
        allDevices.where((device) => device.type == 'AGV').toList();
    filteredDevices.assignAll(agvDevices);
  }
