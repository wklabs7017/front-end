...
class GetDeviceCobotController extends GetxController {
  int? id;
  String? accessToken;
  final Dio dio = Dio();
  ...
  Future<void> fetchDevicesInRange(
    ...
    List<Device> cobotDevices =
        allDevices.where((device) => device.type == 'COBOT').toList();
    filteredDevices.assignAll(cobotDevices);
  }
